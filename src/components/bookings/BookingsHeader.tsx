...
export const BookingsHeader = ({ onNewBooking }: BookingsHeaderProps) => {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 sm:gap-4 relative">
      ...
      <div className="relative z-10 w-full sm:w-auto">
        <Button
          ...
          className="gradient-primary hover:shadow-glow transition-all duration-300 font-semibold h-12 sm:h-14 sm:px-8 text-sm sm:text-base w-full sm:w-auto"
        >
